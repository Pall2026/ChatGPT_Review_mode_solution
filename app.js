/* ==========================================================================
   FINAL DESIGN SYSTEM — UX POLISH (ROUNDS 1-11)
   ========================================================================== */
    ...
    if (targetCard) {
      ...
      tooltip.innerHTML = `
        ...
        <div class="interactive-goal-body">
          Click <strong>Edit</strong> to change this assumption to "<strong>${State.activeTopic.targetEditText}</strong>" and see how it affects the AI's response.
        </div>
      `;
...
function appendReviewControls(row) {
  ...
  container.innerHTML = `
    <div class="chat-actions-footer">
      <button class="footer-btn" aria-label="Copy" title="Copy">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="14" height="14" x="8" y="8" rx="2" ry="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/></svg>
      </button>
      <button class="footer-btn" aria-label="Share" title="Share">
      ...
      <button class="footer-btn" aria-label="Try Again" title="Try Again">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 2v6h-6"/><path d="M3 12a9 9 0 0 1 15-6.7L21 8"/><path d="M3 22v-6h6"/><path d="M21 12a9 9 0 0 1-15 6.7L3 16"/></svg>
      </button>
      ${footerSourcesHtml}
      <button class="btn-review pulse-ring" id="btn-toggle-review">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg>
        Review
        <div class="onboarding-cta-tooltip" id="onboarding-cta-tooltip">
          Curious how I arrived at this answer? Click <strong>Review</strong> to see my reasoning and assumptions.
        </div>
      </button>
...
function toggleReview() {
  ...
  const tooltip = document.getElementById("onboarding-cta-tooltip");
  if (tooltip) tooltip.remove();
